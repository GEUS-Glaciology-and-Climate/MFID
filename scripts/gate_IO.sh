...
# [[file:code.org::*Algorithm][Algorithm:2]]
...
# [[file:code.org::*Algorithm][Algorithm:3]]
...
# [[file:code.org::*Algorithm][Algorithm:4]]
...
# [[file:code.org::*Algorithm][Algorithm:5]]
...
# [[file:code.org::*Algorithm][Algorithm:6]]
...
# [[file:code.org::*Subset to where there is known discharge][Subset to where there is known discharge:1]]
...
# [[file:code.org::*Remove small areas (clusters <X cells)][Remove small areas (clusters <X cells):1]]
...
# [[file:code.org::*Limit to Mouginot 2019 mask][Limit to Mouginot 2019 mask:1]]
...
# [[file:code.org::*Final Gates][Final Gates:1]]
...
# [[file:code.org::*Gate ID][Gate ID:1]]
...
# [[file:code.org::*Mean x,y][Mean x,y:1]]
...
# [[file:code.org::*Mean lon,lat][Mean lon,lat:1]]
...
# [[file:code.org::*Sector, Region, Names, etc.][Sector, Region, Names, etc.:1]]
...
# [[file:code.org::*Clean up][Clean up:1]]
...
# [[file:code.org::*Export as metadata CSV][Export as metadata CSV:1]]
mkdir -p out
...
# [[file:code.org::*Export Gates to KML][Export Gates to KML:1]]
